...
export async function handleThermalCheck(maxTemp = 75) {
    try {
...
export async function handleRebuildSafetyCheck() {
    try {
        const result = {
            thermal_temp: 0,
            thermal_safe: false,
...
export async function handleThermalForensics(duration = 180, skipRebuild = false) {
    try {
...
export async function handleThermalWarroom(duration = 60) {
    try {
...
export async function handleLaptopVerdict(evidenceDir) {
    try {
...
export async function handleFullInvestigation() {
    try {
...
export async function handleForceCooldown() {
    try {
        const script = `
...
export async function handleResetPerformance() {
    try {
        const script = `
      for cpu in /sys/devices/system/cpu/cpu*/cpufreq/scaling_governor; do
