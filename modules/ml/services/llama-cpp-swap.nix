    ...
    settings = lib.mkOption {
      ...
      example = lib.literalExpression ''
        ...
        in
        {
          ...
          models = {
            "some-model" = {
              cmd = "$\{llama-server\} --port ''\${PORT} -m /var/lib/ml-models/llama-cpp/models/Qwen_Qwen2.5-Coder-7B-Instruct-GGUF_qwen2.5-coder-7b-instruct-q6_k-00001-of-00002.gguf -ngl 0 --no-webui";
              aliases = [
                "the-best"
              ];
            };
            "other-model" = {
              ...
              cmd = "$\{llama-server\} --port 5555 -m /var/lib/ml-models/llama-cpp/models/unsloth_Qwen2.5-Coder-14B-Instruct-GGUF_Qwen2.5-Coder-14B-Instruct-Q4_K_M.gguf -ngl 0 -c 4096 -np 4 --no-webui";
              concurrencyLimit = 4;
            };
          };
        };
